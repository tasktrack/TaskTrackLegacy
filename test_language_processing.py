...
class TestLanguageProcessing:
    def test_analyse_formal1(self):
        ...
        test_case1 = lp.analyse(0, '01.01.2001 10:00 Test case 1')[0]
    ...
    def test_analyse_formal2(self):
        lp = LanguageProcessing()
        test_case2 = lp.analyse(0, '01.01.01 10:00 Test case 2')[0]
    ...
    def test_analyse_formal3(self):
        lp = LanguageProcessing()
        test_case3 = lp.analyse(0, '01.01.01 10:00 02.02.02 20:00 Test case 3')[0]
    ...
    def test_analyse_formal4(self):
        lp = LanguageProcessing()
        test_case4 = lp.analyse(0, '01.01.01 10:00 10 мин Test case 4')[0]
    ...
    def test_analyse_formal5(self):
        lp = LanguageProcessing()
        test_case5 = lp.analyse(0, '01.01.01 10:00 Test case 5')[0]
    ...
    def test_analyse_formal6(self):
        lp = LanguageProcessing()
        test_case6 = lp.analyse(0, '01.01.01 10:00 #basic Test case 6')[0]
    ...
    def analyse_formal_full1(self):
        lp = LanguageProcessing()
        test_case_formal_full1 = lp.analyse(0, '01.01.2001 10:00 02.02.02 20:00 10 мин #basic Test case FORMAL FULL 1')[0]
